...
const TodoItem = (props) => {
    ...
    const highlightedTitle = highlightCaseInsensitive(title, searchTask)

    return (
        <li className={clsx(styles.todoItem, className, 
            disappearing === id ? styles.isDisappearing : "", 
            appearing === id ? styles.isAppearing : ""
            ...
            <input
                ...
                type="checkbox"
                checked={isDone}
                onChange={({target}) => handleChangeDone(id, target.checked)}
            />
            <label
